...
class DccomicsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($dccomics as $dccomic) {
            $newDccomic = new Dccomic();
            $newDccomic->title = $dccomic['title'];
            $newDccomic->description = $dccomic['description'];
            $newDccomic->thumb = $dccomic['thumb'];
            $newDccomic->price = $dccomic['price'];
            $newDccomic->series = $dccomic['series'];
            $newDccomic->sale_date = $dccomic['sale_date'];
            $newDccomic->type = $dccomic['type'];
            $newDccomic->save();
        }
    }
}
